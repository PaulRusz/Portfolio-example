...
return (
  ...
  >
    ...
    <div className={styles.portfolio}>
        ...
        <ul>
                <a className={styles.link} href="https://friendsblog.onrender.com/" target="_blank" rel=""> FriendsBlog <br></br><br></br>
        ...
        <div className={styles.projectDivider}>
        <ul>
                <a className={styles.link} href="hhttps://paulrusz.github.io/Group-Project1/" target="_blank" rel=""> Workout Tracker 1.0 <br></br><br></br>
        ...
        <div className={styles.projectDivider}>
        <ul>
                <a className={styles.link} href="https://workout-tracker-3b0i.onrender.com/" target="_blank" rel=""> Workout Tracker 2.0 <br></br><br></br>
